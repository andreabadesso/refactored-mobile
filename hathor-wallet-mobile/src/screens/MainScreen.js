...
class MainScreen extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={{
        flex: 1, backgroundColor: COLORS.backgroundColor, justifyContent: 'flex-start', alignItems: 'center',
      }}
      >
        {this.state.modal}
        <HathorHeader
  ...
  render() {
    ...
    return (
      <TouchableHighlight
        ...
        underlayColor={COLORS.primaryOpacity10}
        style={{ borderRadius: 24, marginHorizontal: 20, marginVertical: 8 }}
      >
